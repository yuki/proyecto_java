...
//	  lin2[2][0]="lsjdalf";*/
  ...
  void BVer_actionPerformed(ActionEvent e) {
	   ...
	   JOptionPane j = new JOptionPane();
           j.showMessageDialog(null,"Debe seleccionar una de las solicitudes que le han sido enviadas\nPinche sobre una solicitud en la tabla","Error, seleccione solicitud",JOptionPane.ERROR_MESSAGE);
       }
  }
} 
